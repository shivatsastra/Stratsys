...
public class SwaggerDocumentationConfig {
	...
	ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Welcome to Stratsys SKI")
				.description("This is the API catalog for Stratsys SKI").license("")
				.licenseUrl("http://unlicense.org").termsOfServiceUrl("").version("1.0.0")
				.contact(new Contact("", "", "shivatsastra@gmail.com")).build();
	}
